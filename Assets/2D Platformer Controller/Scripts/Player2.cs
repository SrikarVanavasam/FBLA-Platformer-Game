...
public class Player2 : MonoBehaviour
{
	...
	public bool starDirection;

	private void Start()
	{	
		//anim = GetComponent<Animator>();
		ninjaStarController = GetComponent<NinjaStarController>(); 
	...
	private void Update()
	{
		...
		if (Input.GetKeyDown (KeyCode.D)) {
			...
			firePoint.transform.localPosition = new Vector2 (0.7f, -0.0f);
			sword.transform.localPosition = new Vector2 (1f, -0.0f);
